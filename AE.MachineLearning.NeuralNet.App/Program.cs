...
namespace AE.MachineLearning.NeuralNet.App
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            try
            {
                ...
                MatrixHelper.PrintVector(weights, 2, true);
                ...
                Console.WriteLine("Setting learning rate (eta) = " + eta.ToString("F2") + " and momentum (alpha) = " +
                                  alpha.ToString("F2"));
                ...
                while (ctr < 1000 && error > 0.01)
                {
                    ...
                    MatrixHelper.PrintVector(yValues, 4, false);
                    Console.WriteLine("\nComputing new error");
                ...
                MatrixHelper.PrintVector(bestWeights, 2, true);
